...
<body onload="openForm(event, 'Quiz')">
	...
	?>	</div>
		...
		<div class="qarea">
				<ul class="tab">
					<li><a href="#" class="formlinks" onclick="go('content.php')">Quiz</a></li>
					<li><a href="#" class="formlinks" onclick="go('stu_profile.php')">Profile</a></li>
					<li><a href="#" class="formlinks" onclick="go('logout.php')">Logout</a></li>
					<li><a href="#" class="formlinks" onclick="go('tmphlpstd.php')">Help</a></li>
				</ul>
					...
					<iframe id="ome" frameborder="0" src="content.php" width="100%" height="550px" noresize="noresize" scrolling="yes" allowtransparency="no"/>
