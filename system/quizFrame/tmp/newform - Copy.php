...
//set quiz_id
			...
			}elseif(isset($_POST["id_me3"])){
				echo "sdddddddddddddddddddddd";
...
Hi!.Add Qection to the Form.Please Make sure Add All before Click Done  
	...
	<?php //  display  file  upload  form
			...
			echo '	<div class="iupload" align="center">
							...
							</form><iframe id="fh" style="display:none;" width="10px" name="frame">
				</br></br>
			<img src="images/insupload.jpg" noresize="resize" alt="ins" align="center" width="300"/>
