...
Hi! Welcome to QMS.Select the quiz you prefer to change . 
	...
	<div class="dybtn">
		...
		while($retVal=mysql_fetch_array($result,MYSQL_ASSOC)){
			foreach($retVal as $cell){
				...
				echo '<input type="submit" onmouseover="bigImg(this)" onmouseout="normalImg(this)" name="id_me" value='.$cell.' style="
				background: #abc904;
